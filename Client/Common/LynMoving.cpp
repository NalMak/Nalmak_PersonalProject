...
//
//
//LynMoving::LynMoving(Desc * _desc)
//{
//}
//
//LynMoving::~LynMoving()
...
//	switch (m_moveState)
//	{
//	case LynMoving::LYN_MOVE_STATE_IDLE:
//		targetSpeed = 0;
//		break;
//	case LynMoving::LYN_MOVE_STATE_RUN:
...
//		break;
//	case LynMoving::LYN_MOVE_STATE_JUMP:
...
//			switch (moveDirState)
//			{
//			case LynMoving::LYN_MOVE_DIR_STATE_FRONT:
//				animName = "Mov_JumpToMove_Front";
//				break;
//			case LynMoving::LYN_MOVE_DIR_STATE_BACK:
//				animName = "Mov_JumpToMove_Back";
//				break;
//			case LynMoving::LYN_MOVE_DIR_STATE_FRONTLEFT:
//			case LynMoving::LYN_MOVE_DIR_STATE_LEFT:
//				animName = "Mov_JumpToMove_Left";
//				break;
//			case LynMoving::LYN_MOVE_DIR_STATE_FRONTRIGHT:
//			case LynMoving::LYN_MOVE_DIR_STATE_RIGHT:
//				animName = "Mov_JumpToMove_Right";
//				break;
//			case LynMoving::LYN_MOVE_DIR_STATE_NONE:
...
//				break;
//			case LynMoving::LYN_MOVE_DIR_STATE_BACKRIGHT:
//				animName = "Mov_RunRightBack";
//				break;
//			case LynMoving::LYN_MOVE_DIR_STATE_BACKLEFT:
...
//}
//
//void LynMoving::UpdateMoveState()
//{
...
//}
//
//void LynMoving::UpdateDirectionByKey()
//{
//	m_targetInput = { 0,0,0 };
