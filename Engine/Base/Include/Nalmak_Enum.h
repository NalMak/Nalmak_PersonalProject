...
{
	SCENE_LOAD_TYPE_NONE,
	SCENE_LOAD_TYPE_DEFAULT,
	SCENE_LOAD_TYPE_THREAD,
	SCENE_LOAD_TYPE_MAX
};
...
enum FRUSTUM_CULLING_STATE
{
	FRUSTUM_CULLING_STATE_FREE_PASS,
	FRUSTUM_CULLING_STATE_READY,
	FRUSTUM_CULLING_STATE_SUCCESS,
	FRUSTUM_CULLING_STATE_FAIL,
	FRUSTUM_CULLING_STATE_MAX
};
#endif